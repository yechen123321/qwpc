    ...
    <div class="main-layout" :class="{ 'drawer-open': isDrawerOpen }">
      ...
      <div class="file-drawer" :class="{ open: isDrawerOpen }">
        ...
        <div class="file-upload-area">
          <label for="file-upload" class="upload-label">
            ...
            <span>上传文件</span>
            <span class="file-types">支持: PDF, DOCX, TXT, MD</span>
          </label>
          <input
            type="file"
            id="file-upload"
      ...
      <div class="main-content">
        ...
        <header class="assistant-header">
          ...
          <h1 @click="goBack" style="cursor: pointer">AI 助手</h1>
        ...
        >
            ...
            >
              <div class="message-avatar">
                ...
                <div v-else class="assistant-avatar">
                  ...
                  >
                    <path
                      d="M12 2a8 8 0 0 1 8 8v12l-4-4-4 4-4-4-4 4V10a8 8 0 0 1 8-8z"
                    ></path>
                  </svg>
                </div>
              </div>
          ...
          <div class="file-preview" v-if="selectedFile">
            ...
            <div class="preview-content">
              ...
              <div
                v-else-if="
                  selectedFile.type === 'txt' || selectedFile.type === 'md'
                "
                class="text-preview"
              >
          ...
          <div class="chat-input-container">
            <div class="input-wrapper">
              ...
              <button class="avatar-toggle-button" @click="toggleAvatar">
                ...
                <span>{{ isAvatarActive ? "隐藏" : "显示" }}数字人</span>
              </button>
            </div>
          </div>
        </div>

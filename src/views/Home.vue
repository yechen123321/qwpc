    ...
    <div class="header" data-ix="show-nav">
        <div class="w-nav nav" data-collapse="medium" data-animation="over-right" data-duration="400" data-contain="1" data-doc-height="1" data-ix="nav-bar-load" data-easing="ease-out-quart" data-easing2="ease-out-quart">
            <div class="w-container">
                ...
                <nav class="w-nav-menu nav-menu" role="navigation">
                    ...
                    <!-- <a class="w-nav-link nav-link sign-up" target="_blank" href="https://bit.ly/1CD88Kh">Go to Webflow.com</a> -->
                </nav>
        ...
        <div class="w-container contents">
            <div class="main-heading-wrapper">
                <h1 data-ix="fade-in-heading">生物纪&nbsp;</h1>
                <h1 data-ix="fade-in-heading-2">Animal</h1>
                <h1 class="without-code" data-ix="fade-in-heading-3">By the Time</h1>
                <h1 class="without-code" data-ix="fade-in-heading-4">Cool</h1>
                <div class="w-hidden-small w-hidden-tiny header-1" data-ix="heading-text-load">Everything you see on this page was built visually in <a style="text-decoration: none; color: black;" target="_blank"  href="https://bit.ly/1CD88Kh">生物纪</a>.</div>
            </div>
...
onMounted(() => {
  ...
  // jQuery 加载完成后再加载 webflow
  jqueryScript.onload = () => {
    const webflowScript = document.createElement('script')
    webflowScript.src = 'https://daks2k3a4ib2z.cloudfront.net/5317d67d660658b254000454/js/webflow.js'

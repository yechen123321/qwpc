<template>
    <div class="publication-detail-page">
      ...
      <section class="breadcrumb-section">
        <div class="container">
          <div class="breadcrumb">
            ...
            <a href="/public" @click.prevent="navigateTo('publications')">出版物</a> &gt; 
      ...
      <template v-else>
        <!-- Publication Hero -->
        <section v-if="publication && publication.title" class="publication-hero" :style="{ backgroundImage: `url(${publication.coverImage})` }">
          <div class="container">

    ...
    <div class="wrapper">
      ...
      <div class="main-container">
        ...
        <div class="main-blogs">
          <div class="main-blog anim" style="--delay: 0.1s">
          ...
          <div class="main-blog anim" style="--delay: 0.2s">
        ...
        <div class="small-header anim" style="--delay: 0.3s">Most Watched</div>
        <div class="videos">
          <div class="video anim" style="--delay: 0.4s">
          ...
          <div class="video anim" style="--delay: 0.5s">
          ...
          <div class="video anim" style="--delay: 0.6s">
          ...
          <div class="video anim" style="--delay: 0.7s">
          ...
          <div class="video-stream">
            ...
            <div class="video-detail">
              <div class="video-content">
                <div class="video-p-wrapper anim" style="--delay: 0.1s">
                ...
                <div class="video-p-subtitle anim" style="--delay: 0.3s">
                  ...
                  Repellendus illum tempora consequuntur. Lorem ipsum dolor sit
                  amet consectetur adipisicing elit. Debitis earum velit
                  accusantium maiores qui sit quas, laborum voluptatibus vero
                  quidem tempore facilis voluptate tempora deserunt!
                </div>
                <div class="video-p-subtitle anim" style="--delay: 0.4s">
                  Lorem ipsum dolor sit amet consectetur adipisicing elit.
          ...
          <div class="chat-stream">
            <div class="chat">
              ...
              <div class="message-container">
                ...
                <div class="message anim" style="--delay: 0.3s">
                  <div class="author-img__wrapper video-author video-p">
                    <svg
                      viewBox="0 0 24 24"
                      fill="none"
                ...
                <div class="message anim" style="--delay: 0.4s">
                  <div class="author-img__wrapper video-author video-p">
                    <svg
                      viewBox="0 0 24 24"
                      fill="none"
                ...
                <div class="message anim" style="--delay: 0.5s">
                  <div class="author-img__wrapper video-author video-p">
                    <svg
                      viewBox="0 0 24 24"
                      fill="none"
                ...
                <div class="message anim" style="--delay: 0.6s">
                  <div class="author-img__wrapper video-author video-p">
                    <svg
                      viewBox="0 0 24 24"
                      fill="none"
              ...
              <div class="chat-footer anim" style="--delay: 0.1s">
                <input type="text" placeholder="Write your message" />
              </div>
            </div>
            <div class="chat-vid__container">
              <div class="chat-vid__title anim" style="--delay: 0.3s">
                Related Videos
              </div>
              <div class="chat-vid anim" style="--delay: 0.4s">
              ...
              <div class="chat-vid anim" style="--delay: 0.5s">
                <div class="chat-vid__wrapper">
                  <img
                    class="chat-vid__img"
              ...
              <div class="chat-vid__button anim" style="--delay: 0.6s">
